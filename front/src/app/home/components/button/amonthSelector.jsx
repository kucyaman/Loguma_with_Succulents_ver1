      ...
      <div className="flex gap-6">
        {Array.from({ length: 12 }, (_, i) => (
          <div
            ...
            className={`w-auto flex-none h-12 flex items-center justify-center text-lg cursor-pointer select-none ${selectedMonth === i + 1 ? "border-b-2 border-custom-dark-pink text-custom-pink" : ""}`}
